...
if __name__ == "__main__":
  ...
  if producer_type == "kinesis":
    ...
    conf[producer_prefix + 'create_stream'] = bool(int(os.getenv('create_stream', 0)))
    conf[producer_prefix + 'verify_certificates'] = bool(int(os.getenv('verify_certificates', 1)))
