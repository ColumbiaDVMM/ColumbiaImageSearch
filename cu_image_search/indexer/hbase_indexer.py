...
class HBaseIndexer(GenericIndexer):
    ...
    def initialize_sha1_mapping(self):
        ...
        try:
            start_load_sha1_featid_mapping = time.time()
    ...
    def get_rows_by_batch(self, list_queries, table_name, columns=None, previous_err=0, inst=None):
        ...
        try:
            with self.pool.connection() as connection:
                ...
                return rows
        except (timeout or TTransportException or TException or IOError) as inst:
    ...
    def get_sim_infos(self, list_ids, columns=None):
        ...
        try:
            ...
            print("[HBaseIndexer.get_sim_infos: log] caught error: {}. The index might need to be refreshed, thus 'sha1_featid_mapping' is out of date.".format(inst))
            self.initialize_sha1_mapping()
