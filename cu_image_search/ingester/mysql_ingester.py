...
class MySQLIngester(GenericIngester):
    ...
    def initialize_source(self):
        ...
        """
        self.host = global_var['ist_db_host']
        self.user = global_var['ist_db_user']
        self.pwd = global_var['ist_db_pwd']
        self.db = global_var['ist_db_dbname']
    ...
    def get_batch(self):
        ...
        if self.start is None or self.batch_size is None:
            print "[MySQLIngester.get_batch: error] Parameters 'start' or 'batch_size' not set."
            return None
